...
export default function RefinementFilters(props: Props) {
  ...
  const hasActive = props.selectedRegion || props.selectedCepage || props.selectedPlat || props.selectedBio
    ...
    <div style={{ marginTop: 16 }}>
      ...
      {open && (
        <div style={{
          ...
          <ChipRow label="🗺️ Région" items={props.regions} selected={props.selectedRegion} onSelect={props.onRegion} />
